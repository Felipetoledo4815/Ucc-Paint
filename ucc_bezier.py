...
class CG_BezierC():
    def __init__(self, layer, x, y, width = 2.0, color = 0xff0000ff):
        ...
        self.markers = [CG_Marker(layer, x, y, self.handler1),
                        CG_Marker(layer, x, y, self.handler2),
                        CG_Marker(layer, x, y, self.handler3),
                        CG_Marker(layer, x, y, self.handler4)]
    ...
    def handler1(self, x, y):
        ...
        self.xf = self.xf + dx
        self.yf = self.yf + dy
        self.cx1 = self.cx1 + dx
        self.cy1 = self.cy1 + dy
        self.cx2 = self.cx2 + dx
        self.cy2 = self.cy2 + dy

        self.markers[1].goto_x_y(self.cx1, self.cy1, False)
        self.markers[2].goto_x_y(self.cx2, self.cy2, False)
        self.markers[3].goto_x_y(self.xf, self.yf, False)
